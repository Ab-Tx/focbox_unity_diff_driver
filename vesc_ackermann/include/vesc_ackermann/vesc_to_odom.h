...
private:
  ...
  focbox_unity_msgs::FocboxUnityStateStamped::ConstPtr last_state_; ///< Last received state message
  ...
  // ROS callbacks
  void vescStateCB(const focbox_unity_msgs::FocboxUnityStateStamped::ConstPtr& state);
  void servoCmdCB(const std_msgs::Float64::ConstPtr& servo);
};
